...
package com.sdkfz.world.inventory;
...
public class InventoryGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public InventoryGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SdkfzModMenus.INVENTORY_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 8) {
			...
			private int x = InventoryGuiMenu.this.x;
			private int y = InventoryGuiMenu.this.y;
		}));
